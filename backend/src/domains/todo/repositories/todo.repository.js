...
class TodoRepository {
    ...
    async create(todoData) {
        const query = 'INSERT INTO todo (m_idx, c_idx, t_name, t_content, target_date) VALUES ($1, $2, $3, $4, $5)';
    ...
    async update(tidx, todoData) {
        const query = 'UPDATE todo SET t_name = $1, t_content = $2, target_date = $3, updated_at = NOW() WHERE t_idx = $4 AND m_idx = $5';
    ...
    async updateState(tidx, todoData) {
        const query = 'UPDATE todo SET t_state = $1, updated_at = NOW() WHERE t_idx = $2 AND m_idx = $3';
    ...
    async delete(tidx, midx) {
        const query = 'DELETE FROM todo WHERE t_idx = $1 AND m_idx = $2';
